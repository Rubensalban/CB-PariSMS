...
public class Dialog10 extends DialogFragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FileCacher<String> match_10 = new FileCacher<>(getContext(), "data10.txt");
        FileCacher<String> set_true_match_10 = new FileCacher<>(getContext(), "true10.txt");
        ...
        btn_valide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((io.isEmpty())  && (Bet_ID == 0)){
                    ...
                    try {
                        match_10.writeCache(io);
                        set_true_match_10.writeCache(io);
                    ...
                    if (Bet_ID == m_273) {
                        try {
                            set_true_match_10.writeCache("1/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_274) {
                        try {
                            set_true_match_10.writeCache("x/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_275) {
                        try {
                            set_true_match_10.writeCache("2/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_280) {
                        try {
                            set_true_match_10.writeCache("oui/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_279) {
                        try {
                            set_true_match_10.writeCache("non/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_341) {
                        try {
                            set_true_match_10.writeCache("3+/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_339) {
                        try {
                            set_true_match_10.writeCache("0but/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_338) {
                        try {
                            set_true_match_10.writeCache("1but/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_337) {
                        try {
                            set_true_match_10.writeCache("2+but/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_336) {
                        try {
                            set_true_match_10.writeCache("1er");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_335) {
                        try {
                            set_true_match_10.writeCache("2e");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_334) {
                        try {
                            set_true_match_10.writeCache("egalite");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_323) {
                        try {
                            set_true_match_10.writeCache("oui1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_355) {
                        try {
                            set_true_match_10.writeCache("non1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_356) {
                        try {
                            set_true_match_10.writeCache("oui2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_357) {
                        try {
                            set_true_match_10.writeCache("non2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_301) {
                        try {
                            set_true_match_10.writeCache("1xoui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_276) {
                        try {
                            set_true_match_10.writeCache("12non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_361) {
                        try {
                            set_true_match_10.writeCache("x2oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_358) {
                        try {
                            set_true_match_10.writeCache("1xnon");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_359) {
                        try {
                            set_true_match_10.writeCache("12oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_360) {
                        try {
                            set_true_match_10.writeCache("x2non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_362) {
                        try {
                            set_true_match_10.writeCache("1oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_363) {
                        try {
                            set_true_match_10.writeCache("1non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_364) {
                        try {
                            set_true_match_10.writeCache("xoui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_365) {
                        try {
                            set_true_match_10.writeCache("xnon");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_366) {
                        try {
                            set_true_match_10.writeCache("2oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_367) {
                        try {
                            set_true_match_10.writeCache("2non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_368) {
                        try {
                            set_true_match_10.writeCache("1_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_369) {
                        try {
                            set_true_match_10.writeCache("x_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_370) {
                        try {
                            set_true_match_10.writeCache("2_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_374) {
                        try {
                            set_true_match_10.writeCache("1_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_375) {
                        try {
                            set_true_match_10.writeCache("x_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_376) {
                        try {
                            set_true_match_10.writeCache("2_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_380) {
                        try {
                            set_true_match_10.writeCache("1_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_381) {
                        try {
                            set_true_match_10.writeCache("x_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_382) {
                        try {
                            set_true_match_10.writeCache("2_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_386) {
                        try {
                            set_true_match_10.writeCache("1_5-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_387) {
                        try {
                            set_true_match_10.writeCache("x_5-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_388) {
                        try {
                            set_true_match_10.writeCache("2_5-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_392) {
                        try {
                            set_true_match_10.writeCache("1x_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_393) {
                        try {
                            set_true_match_10.writeCache("12_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_394) {
                        try {
                            set_true_match_10.writeCache("x2_2-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_351) {
                        try {
                            set_true_match_10.writeCache("1x_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_350) {
                        try {
                            set_true_match_10.writeCache("12_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_349) {
                        try {
                            set_true_match_10.writeCache("x2_3-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_319) {
                        try {
                            set_true_match_10.writeCache("1x_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_348) {
                        try {
                            set_true_match_10.writeCache("12_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_347) {
                        try {
                            set_true_match_10.writeCache("x2_4-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_237) {
                        try {
                            set_true_match_10.writeCache("1x_5-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_236) {
                        try {
                            set_true_match_10.writeCache("12_5-");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_234) {
                        try {
                            set_true_match_10.writeCache("x2_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_233) {
                        try {
                            set_true_match_10.writeCache("oui3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_231) {
                        try {
                            set_true_match_10.writeCache("non3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_229) {
                        try {
                            set_true_match_10.writeCache("2buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_226) {
                        try {
                            set_true_match_10.writeCache("3buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_225) {
                        try {
                            set_true_match_10.writeCache("4buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_224) {
                        try {
                            set_true_match_10.writeCache("5buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_223) {
                        try {
                            set_true_match_10.writeCache("6+buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_135) {
                        try {
                            set_true_match_10.writeCache("1_0but");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_134) {
                        try {
                            set_true_match_10.writeCache("1_1but");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_133) {
                        try {
                            set_true_match_10.writeCache("1_2buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_132) {
                        try {
                            set_true_match_10.writeCache("1_3+buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_131) {
                        try {
                            set_true_match_10.writeCache("2_0but");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_130) {
                        try {
                            set_true_match_10.writeCache("2_1but");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_129) {
                        try {
                            set_true_match_10.writeCache("2_2buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_128) {
                        try {
                            set_true_match_10.writeCache("2_3+buts");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_127) {
                        try {
                            set_true_match_10.writeCache("1impair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_126) {
                        try {
                            set_true_match_10.writeCache("1pair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_125) {
                        try {
                            set_true_match_10.writeCache("2impair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_124) {
                        try {
                            set_true_match_10.writeCache("2pair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_123) {
                        try {
                            set_true_match_10.writeCache("oui1/1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_122) {
                        try {
                            set_true_match_10.writeCache("non1/1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_121) {
                        try {
                            set_true_match_10.writeCache("oui2/2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_120) {
                        try {
                            set_true_match_10.writeCache("non2/2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_119) {
                        try {
                            set_true_match_10.writeCache("oui1/oui1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_118) {
                        try {
                            set_true_match_10.writeCache("non1/non1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_5) {
                        try {
                            set_true_match_10.writeCache("oui2/oui2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_8) {
                        try {
                            set_true_match_10.writeCache("non2/non2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_117) {
                        try {
                            set_true_match_10.writeCache("xlast");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_116) {
                        try {
                            set_true_match_10.writeCache("1last");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_115) {
                        try {
                            set_true_match_10.writeCache("2last");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_243) {
                        try {
                            set_true_match_10.writeCache("1x/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_242) {
                        try {
                            set_true_match_10.writeCache("12/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_240) {
                        try {
                            set_true_match_10.writeCache("x2/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_107) {
                        try {
                            set_true_match_10.writeCache("1x_oui/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_106) {
                        try {
                            set_true_match_10.writeCache("1x_non/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_105) {
                        try {
                            set_true_match_10.writeCache("12_oui/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_104) {
                        try {
                            set_true_match_10.writeCache("12_non/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_103) {
                        try {
                            set_true_match_10.writeCache("x2_oui/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_102) {
                        try {
                            set_true_match_10.writeCache("x2_non/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_99) {
                        try {
                            set_true_match_10.writeCache("1v/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_98) {
                        try {
                            set_true_match_10.writeCache("2v/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_97) {
                        try {
                            set_true_match_10.writeCache("1(1:0)/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_96) {
                        try {
                            set_true_match_10.writeCache("x(1:0)/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_95) {
                        try {
                            set_true_match_10.writeCache("2(1:0)/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_90) {
                        try {
                            set_true_match_10.writeCache("1_1+but/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_88) {
                        try {
                            set_true_match_10.writeCache("2_1+but/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_82) {
                        try {
                            set_true_match_10.writeCache("0:0/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_81) {
                        try {
                            set_true_match_10.writeCache("0:1/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_80) {
                        try {
                            set_true_match_10.writeCache("0:2/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_79) {
                        try {
                            set_true_match_10.writeCache("1:0/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_78) {
                        try {
                            set_true_match_10.writeCache("1:1/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_77) {
                        try {
                            set_true_match_10.writeCache("1:2/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_76) {
                        try {
                            set_true_match_10.writeCache("2:0/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_75) {
                        try {
                            set_true_match_10.writeCache("2:1/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_74) {
                        try {
                            set_true_match_10.writeCache("2:2/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_73) {
                        try {
                            set_true_match_10.writeCache("impair/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_72) {
                        try {
                            set_true_match_10.writeCache("pair/");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_62) {
                        try {
                            set_true_match_10.writeCache("1x_/oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_61) {
                        try {
                            set_true_match_10.writeCache("1x_/non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_60) {
                        try {
                            set_true_match_10.writeCache("12_/oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_59) {
                        try {
                            set_true_match_10.writeCache("12_/non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_58) {
                        try {
                            set_true_match_10.writeCache("x2_/oui");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_57) {
                        try {
                            set_true_match_10.writeCache("x2_/non");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_28) {
                        try {
                            set_true_match_10.writeCache("x_1erbut");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_27) {
                        try {
                            set_true_match_10.writeCache("1_1erbut");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_13) {
                        try {
                            set_true_match_10.writeCache("2_1erbut");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_49) {
                        try {
                            set_true_match_10.writeCache("1erbut_1/1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_50) {
                        try {
                            set_true_match_10.writeCache("1erbut_1/x");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_36) {
                        try {
                            set_true_match_10.writeCache("1erbut_1/2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_26) {
                        try {
                            set_true_match_10.writeCache("1erbut_2/1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_25) {
                        try {
                            set_true_match_10.writeCache("1erbut_2/x");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_24) {
                        try {
                            set_true_match_10.writeCache("1erbut_2/2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_12) {
                        try {
                            set_true_match_10.writeCache("1erbut_0");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_154) {
                        try {
                            set_true_match_10.writeCache("1_1+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_163) {
                        try {
                            set_true_match_10.writeCache("2_1+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_150) {
                        try {
                            set_true_match_10.writeCache("c_impair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_149) {
                        try {
                            set_true_match_10.writeCache("c_pair");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_146) {
                        try {
                            set_true_match_10.writeCache("1c");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_145) {
                        try {
                            set_true_match_10.writeCache("xc");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_142) {
                        try {
                            set_true_match_10.writeCache("2c");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_141) {
                        try {
                            set_true_match_10.writeCache("1/1_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_165) {
                        try {
                            set_true_match_10.writeCache("1/x_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_162) {
                        try {
                            set_true_match_10.writeCache("1/2_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_152) {
                        try {
                            set_true_match_10.writeCache("x/1_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_148) {
                        try {
                            set_true_match_10.writeCache("x/x_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_144) {
                        try {
                            set_true_match_10.writeCache("x/2_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_140) {
                        try {
                            set_true_match_10.writeCache("2/1_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_164) {
                        try {
                            set_true_match_10.writeCache("2/x_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_161) {
                        try {
                            set_true_match_10.writeCache("2/2_2+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_197) {
                        try {
                            set_true_match_10.writeCache("1/1_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_196) {
                        try {
                            set_true_match_10.writeCache("1/x_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_195) {
                        try {
                            set_true_match_10.writeCache("1/2_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_194) {
                        try {
                            set_true_match_10.writeCache("x/1_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_193) {
                        try {
                            set_true_match_10.writeCache("x/x_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_192) {
                        try {
                            set_true_match_10.writeCache("x/2_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_191) {
                        try {
                            set_true_match_10.writeCache("2/1_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_190) {
                        try {
                            set_true_match_10.writeCache("2/x_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_189) {
                        try {
                            set_true_match_10.writeCache("2/2_3+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_174) {
                        try {
                            set_true_match_10.writeCache("1/1_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_171) {
                        try {
                            set_true_match_10.writeCache("1/x_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_185) {
                        try {
                            set_true_match_10.writeCache("1/2_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_182) {
                        try {
                            set_true_match_10.writeCache("x/1_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_179) {
                        try {
                            set_true_match_10.writeCache("x/x_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_176) {
                        try {
                            set_true_match_10.writeCache("x/2_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_173) {
                        try {
                            set_true_match_10.writeCache("2/1_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_170) {
                        try {
                            set_true_match_10.writeCache("2/x_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_395) {
                        try {
                            set_true_match_10.writeCache("2/2_4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_219) {
                        try {
                            set_true_match_10.writeCache("1/1_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_218) {
                        try {
                            set_true_match_10.writeCache("1/x_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_217) {
                        try {
                            set_true_match_10.writeCache("1/2_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_216) {
                        try {
                            set_true_match_10.writeCache("x/1_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_215) {
                        try {
                            set_true_match_10.writeCache("x/x_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_214) {
                        try {
                            set_true_match_10.writeCache("x/2_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_213) {
                        try {
                            set_true_match_10.writeCache("2/1_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_212) {
                        try {
                            set_true_match_10.writeCache("2/x_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_211) {
                        try {
                            set_true_match_10.writeCache("2/2_5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_201) {
                        try {
                            set_true_match_10.writeCache("x/x_0");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_200) {
                        try {
                            set_true_match_10.writeCache("1/1_1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_199) {
                        try {
                            set_true_match_10.writeCache("x/1_1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_281) {
                        try {
                            set_true_match_10.writeCache("x/2_1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_282) {
                        try {
                            set_true_match_10.writeCache("2/2_1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_305) {
                        try {
                            set_true_match_10.writeCache("4+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_303) {
                        try {
                            set_true_match_10.writeCache("5+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_300) {
                        try {
                            set_true_match_10.writeCache("6+");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_298) {
                        try {
                            set_true_match_10.writeCache("1(0:1)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_297) {
                        try {
                            set_true_match_10.writeCache("x(0:1)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_296) {
                        try {
                            set_true_match_10.writeCache("2(0:1)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_295) {
                        try {
                            set_true_match_10.writeCache("1(0:2)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_294) {
                        try {
                            set_true_match_10.writeCache("x(0:2)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_293) {
                        try {
                            set_true_match_10.writeCache("2(0:2)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_289) {
                        try {
                            set_true_match_10.writeCache("1(2:0)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_288) {
                        try {
                            set_true_match_10.writeCache("x(2:0)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_287) {
                        try {
                            set_true_match_10.writeCache("2(2:0)");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_252) {
                        try {
                            set_true_match_10.writeCache("x/1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_250) {
                        try {
                            set_true_match_10.writeCache("1/x");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_249) {
                        try {
                            set_true_match_10.writeCache("x/x");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_248) {
                        try {
                            set_true_match_10.writeCache("2/x");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_246) {
                        try {
                            set_true_match_10.writeCache("x/2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_137) {
                        try {
                            set_true_match_10.writeCache("2-3");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_136) {
                        try {
                            set_true_match_10.writeCache("4-5");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_48) {
                        try {
                            set_true_match_10.writeCache("0:3");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_46) {
                        try {
                            set_true_match_10.writeCache("0:4");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_21) {
                        try {
                            set_true_match_10.writeCache("1:3");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_19) {
                        try {
                            set_true_match_10.writeCache("1:4");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    ...
                    if (Bet_ID == m_43) {
                        try {
                            set_true_match_10.writeCache("2:4");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_41) {
                        try {
                            set_true_match_10.writeCache("3:0");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_22) {
                        try {
                            set_true_match_10.writeCache("3:1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_20) {
                        try {
                            set_true_match_10.writeCache("3:2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_18) {
                        try {
                            set_true_match_10.writeCache("3:3");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_16) {
                        try {
                            set_true_match_10.writeCache("3:4");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_14) {
                        try {
                            set_true_match_10.writeCache("4:0");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_168) {
                        try {
                            set_true_match_10.writeCache("4:1");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_167) {
                        try {
                            set_true_match_10.writeCache("4:2");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_160) {
                        try {
                            set_true_match_10.writeCache("4:3");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_159) {
                        try {
                            set_true_match_10.writeCache("4:4");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
                    if (Bet_ID == m_158) {
                        try {
                            set_true_match_10.writeCache("autre");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
